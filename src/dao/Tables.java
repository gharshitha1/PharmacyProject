...
public class Tables{
    public static void main(String[] args){
        try{
            ...
            //st.executeUpdate("create table medicine(medicine_pk int AUTO_INCREMENT primary key,uniqueId varchar(200),name varchar(200),companyName varchar(50),quantity bigint,price bigint,dob varchar(50) )");
            ...
            //st.executeUpdate("ALTER TABLE medicine CHANGE COLUMN dob expiryDate varchar(50)");
